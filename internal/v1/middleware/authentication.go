...
func (m *Middleware) ServerAuthenticationInterceptor(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
	...
	methods := map[string]string{
		...
		"/baseca.v1.Accounts/CreateUser":             _pass_auth, // Temporarily Bypass Authentication
	}
...
func (m *Middleware) AuthenticateServiceAccount(ctx context.Context) (*authentication.ServicePayload, error) {
	...
	cachedServiceAccount, err := m.authenticationCache(ctx, client_uuid)
	if err != nil {
...
func (m *Middleware) authenticationCache(ctx context.Context, client_uuid uuid.UUID) (*db.CachedServiceAccount, error) {
